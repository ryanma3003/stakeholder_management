(function($) {
 ...
 var dlabSparkLine = function(){
	...
	var radarChart1 = function(){	
		if(jQuery('#radar_chart1').length > 0 ){
			//radar chart
			const radar_chart1 = document.getElementById("radar_chart1").getContext('2d');

			const radar_chartgradientStroke1 = radar_chart1.createLinearGradient(500, 0, 100, 0);
			radar_chartgradientStroke1.addColorStop(0, "rgba(54, 185, 216, .5)");
			radar_chartgradientStroke1.addColorStop(1, "rgba(75, 255, 162, .5)");

			const radar_chartgradientStroke2 = radar_chart1.createLinearGradient(500, 0, 100, 0);
			radar_chartgradientStroke2.addColorStop(0, "rgba(68, 0, 235, .5");
			radar_chartgradientStroke2.addColorStop(1, "rgba(68, 236, 245, .5");

			// radar_chart.height = 100;
			new Chart(radar_chart1, {
				type: 'radar',
				data: {
					defaultFontFamily: 'Poppins',
